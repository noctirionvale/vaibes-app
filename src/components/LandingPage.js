...
const LandingPage = () => {
  ...
  // Intro auto-dismiss after animation completes
  useEffect(() => {
  ...
  return (
    <>
      {/* ═══════════ INTRO ANIMATION ═══════════ */}
      <div className={`vaibes-intro ${introComplete ? 'intro-done' : ''}`}>
        <div className="vaibes-intro-bg" />
        <div className="vaibes-intro-content">
          <div className="vaibes-intro-logo">
            <img src="hero.ai.png" alt="" className="vaibes-intro-img" />
          </div>
          <div className="vaibes-intro-word">
            {'vAIbes'.split('').map((char, i) => (
              <span
                key={i}
                className="vaibes-intro-char"
          ...
          <div className="vaibes-intro-tagline">
            Demystify AI Through Action, Not Hype.
          </div>
          <div className="vaibes-intro-bar">
            <div className="vaibes-intro-bar-fill" />
          </div>
        </div>
      </div>

      {/* ═══════════ LANDING PAGE ═══════════ */}
      <div className={`landing-page landing-reveal ${introComplete ? 'revealed' : ''}`}>
        ...
        <section className="landing-features">
          <div className="landing-features-inner">
            <h2 className="landing-section-title">
              Everything you need, <span className="landing-accent">all in one place</span>.
            </h2>
            ...
            <div className="landing-features-grid">
              <div className="landing-feature-card">
                ...
                <h3>Study Mode</h3>
                <p>Play lo‑fi, jazz, or deep focus music from YouTube while you work. No distractions.</p>
              </div>
              <div className="landing-feature-card">
                <div className="landing-feature-icon">📹</div>
                <h3>Live Cams & Wallpapers</h3>
                <p>Embed zoo, aquarium, or city live cams. Download stunning wallpapers with one click.</p>
              </div>
              <div className="landing-feature-card">
                <div className="landing-feature-icon">🤖</div>
                <h3>AI Chat <span style={{ fontSize: '0.7rem', background: 'var(--accent1)', padding: '2px 6px', borderRadius: '20px', color: 'white', marginLeft: '6px' }}>Pro</span></h3>
                <p>Ask anything — get clear, human‑sounding answers. Works with text, YouTube transcripts.</p>
              </div>
              <div className="landing-feature-card">
                <div className="landing-feature-icon">💬</div>
                <h3>User‑to‑User DMs <span style={{ fontSize: '0.7rem', background: 'var(--accent1)', padding: '2px 6px', borderRadius: '20px', color: 'white', marginLeft: '6px' }}>Pro</span></h3>
                <p>Real‑time messaging with other vAIbes users. Perfect for study groups or communities.</p>
              </div>
              <div className="landing-feature-card">
                <div className="landing-feature-icon">📥</div>
                <h3>Download & Share</h3>
                <p>One‑click download of wallpapers and video clips. Apple‑style design, zero friction.</p>
              </div>
              <div className="landing-feature-card">
                <div className="landing-feature-icon">⭐</div>
                <h3>Featured Highlights</h3>
                <p>Admins (or users) can promote any card to the top — live cams, trailers, wallpapers, anything.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <footer className="landing-footer">
          ...
          <p className="landing-footer-tagline">
            Demystify AI Through Action, Not Hype.<br />
            Study. Chill. Connect. All in one tab.
          </p>
