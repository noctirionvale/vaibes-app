        ...
        <div className="settings-tab-content">
          ...
          {activeTab === 'billing' && (
            <div className="billing-panel">
              <p className="billing-current">Current Plan: <span className={`billing-badge ${userTier}`}>{userTier.toUpperCase()}</span></p>
              <p className="billing-usage">{userTier === 'pro' ? '✅ 50 requests/day' : '0 AI requests · Upgrade to Pro'}</p>
              <div className="billing-tiers">
                ...
                <div className={`billing-tier ${userTier === 'pro' ? 'current-tier' : ''}`}>
                  ...
                  <div className="tier-header"><span className="tier-name">Pro</span><span className="tier-price">₱199 <small>/month</small></span></div>
                  <ul className="tier-features">
                    <li>✅ 50 AI requests/day</li>
                    <li>✅ All AI modes (Explain, Summarize, etc.)</li>
                    <li>✅ YouTube channel feed</li>
                    <li>✅ Study Mode + Media gallery</li>
                  </ul>
                  {userTier !== 'pro' && (
